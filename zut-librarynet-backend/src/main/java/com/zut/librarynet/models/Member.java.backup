...
public abstract class Member {
    ...
    private String validatePhone(String phone) {
        ...
        // UPDATED: Accept international phone numbers
        // Allow: +1234567890, 0977123456, etc.
        // Format: optional + followed by 6-15 digits
        phone = phone.trim();
        if (!phone.matches("^[+]?[0-9]{6,15}$")) {
            throw new IllegalArgumentException("Invalid phone number. Must be 6-15 digits (with optional + prefix)");
        }
        return phone;
    }
